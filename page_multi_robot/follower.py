...
def mir1_pose_callback(msg):
    ...
    xl = msg.pose.pose.position.x
    yl = msg.pose.pose.position.y
...
def main():
    ...
    rospy.Subscriber("/mir2/amcl_pose", PoseWithCovarianceStamped, mir2_pose_callback)
    rospy.Subscriber("/mir/amcl_pose", PoseWithCovarianceStamped, mir1_pose_callback)
    global cmd_vel_pub
    cmd_vel_pub = rospy.Publisher("/mir2/mobile_base_controller/cmd_vel", Twist, queue_size=1000)
